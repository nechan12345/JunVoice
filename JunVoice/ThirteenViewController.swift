...
class ThirteenViewController: BaseViewController {
    let Path0 = Bundle.main.bundleURL.appendingPathComponent("・・・！.mp3")
    let Path1 = Bundle.main.bundleURL.appendingPathComponent("…!.mp3")
    let Path2 = Bundle.main.bundleURL.appendingPathComponent("クポクポ〜.mp3")
    let Path3 = Bundle.main.bundleURL.appendingPathComponent("ねもうす鳥.mp3")
    let Path4 = Bundle.main.bundleURL.appendingPathComponent("あはははははは.mp3")
    let Path5 = Bundle.main.bundleURL.appendingPathComponent("あっはは！.mp3")
    let Path6 = Bundle.main.bundleURL.appendingPathComponent("ハッハッハー！.mp3")
    let Path7 = Bundle.main.bundleURL.appendingPathComponent("あぁ、あぁ.mp3")
    let Path8 = Bundle.main.bundleURL.appendingPathComponent("アクセル.mp3")
    let Path9 = Bundle.main.bundleURL.appendingPathComponent("ハーレの音.mp3")
    let Path10 = Bundle.main.bundleURL.appendingPathComponent("ハーレ長尺.mp3")
    let Path11 = Bundle.main.bundleURL.appendingPathComponent("あえぎ声.mp3")
    let Path12 = Bundle.main.bundleURL.appendingPathComponent("クンクン.mp3")
