...
class TenViewController: BaseViewController {
    let Path0 = Bundle.main.bundleURL.appendingPathComponent("よーし.mp3")
    let Path1 = Bundle.main.bundleURL.appendingPathComponent("よーし(沼).mp3")
    let Path2 = Bundle.main.bundleURL.appendingPathComponent("よーし(大声).mp3")
    let Path3 = Bundle.main.bundleURL.appendingPathComponent("おーーし.mp3")
    let Path4 = Bundle.main.bundleURL.appendingPathComponent("わらぁ鬼の子だ.mp3")
    let Path5 = Bundle.main.bundleURL.appendingPathComponent("あじすんだーおー.mp3")
    let Path6 = Bundle.main.bundleURL.appendingPathComponent("かってもさ.mp3")
    let Path7 = Bundle.main.bundleURL.appendingPathComponent("はーけんべーさ.mp3")
    let Path8 = Bundle.main.bundleURL.appendingPathComponent("なにー？.mp3")
    let Path9 = Bundle.main.bundleURL.appendingPathComponent("やってるー？.mp3")
    let Path10 = Bundle.main.bundleURL.appendingPathComponent("あーにー？やってるー？.mp3")
    let Path11 = Bundle.main.bundleURL.appendingPathComponent("やってるよー.mp3")
    let Path12 = Bundle.main.bundleURL.appendingPathComponent("エッサッサ.mp3")
