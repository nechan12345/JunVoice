...
class FirstViewController: BaseViewController{
    ...
    let Path6 = Bundle.main.bundleURL.appendingPathComponent("俺加藤だけどなんだあれ.mp3")
    ...
    let Path10 = Bundle.main.bundleURL.appendingPathComponent("じゃーねー.mp3")
    let Path11 = Bundle.main.bundleURL.appendingPathComponent("ばいばーい.mp3")
    let Path12 = Bundle.main.bundleURL.appendingPathComponent("ありがとね普通.mp3")
