...
class EightViewController: BaseViewController {
    let Path0 = Bundle.main.bundleURL.appendingPathComponent("変身！.mp3")
    let Path1 = Bundle.main.bundleURL.appendingPathComponent("変身（ピンチ）.mp3")
    let Path2 = Bundle.main.bundleURL.appendingPathComponent("開眼！.mp3")
    let Path3 = Bundle.main.bundleURL.appendingPathComponent("命燃やすぜ！.mp3")
    let Path4 = Bundle.main.bundleURL.appendingPathComponent("フジヤマ落としじゃい.mp3")
    let Path5 = Bundle.main.bundleURL.appendingPathComponent("バックナックル.mp3")
    let Path6 = Bundle.main.bundleURL.appendingPathComponent("ドラゴンナックル.mp3")
    let Path7 = Bundle.main.bundleURL.appendingPathComponent("右ストレート.mp3")
    let Path8 = Bundle.main.bundleURL.appendingPathComponent("トドメじゃあーー.mp3")
    let Path9 = Bundle.main.bundleURL.appendingPathComponent("おれは一撃でいい.mp3")
    let Path10 = Bundle.main.bundleURL.appendingPathComponent("危ないショーン当たっちゃうよ.mp3")
    let Path11 = Bundle.main.bundleURL.appendingPathComponent("耳元で騒ぐな.mp3")
    let Path12 = Bundle.main.bundleURL.appendingPathComponent("ちょっとー、なーにやってんのー.mp3")
    let Path13 = Bundle.main.bundleURL.appendingPathComponent("ブレストファイヤー！.mp3")
    let Path14 = Bundle.main.bundleURL.appendingPathComponent("ハイメガキャノン.mp3")
