...
class FifthViewController: BaseViewController  {
    ...
    let Path11 = Bundle.main.bundleURL.appendingPathComponent("okokGOGO.mp3")
    let Path12 = Bundle.main.bundleURL.appendingPathComponent("ナイスナイス.mp3")
    let Path13 = Bundle.main.bundleURL.appendingPathComponent("ないすぅ！.mp3")
    let Path14 = Bundle.main.bundleURL.appendingPathComponent("ないす4回.mp3")
