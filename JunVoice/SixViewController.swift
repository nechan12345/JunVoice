...
class SixViewController: BaseViewController {
    ...
    let Path12 = Bundle.main.bundleURL.appendingPathComponent("ストライクバイバイ.mp3")
    let Path13 = Bundle.main.bundleURL.appendingPathComponent("ボールでいいよ.mp3")
    ...
    let Path19 = Bundle.main.bundleURL.appendingPathComponent("マリオ.mp3")
