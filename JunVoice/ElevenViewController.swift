...
class ElevenViewController: BaseViewController {
    let Path0 = Bundle.main.bundleURL.appendingPathComponent("セイーー.mp3")
    let Path1 = Bundle.main.bundleURL.appendingPathComponent("セイー.mp3")
    let Path2 = Bundle.main.bundleURL.appendingPathComponent("セェイ.mp3")
    let Path3 = Bundle.main.bundleURL.appendingPathComponent("セイ.mp3")
    let Path4 = Bundle.main.bundleURL.appendingPathComponent("すぃー(低).mp3")
    let Path5 = Bundle.main.bundleURL.appendingPathComponent("すぃー.mp3")
    let Path6 = Bundle.main.bundleURL.appendingPathComponent("スェィー.mp3")
    let Path7 = Bundle.main.bundleURL.appendingPathComponent("ステイー.mp3")
    let Path8 = Bundle.main.bundleURL.appendingPathComponent("テイー.mp3")
    let Path9 = Bundle.main.bundleURL.appendingPathComponent("テイー（高）.mp3")
    let Path10 = Bundle.main.bundleURL.appendingPathComponent("テイ！.mp3")
    let Path11 = Bundle.main.bundleURL.appendingPathComponent("コワイー.mp3")
    let Path12 = Bundle.main.bundleURL.appendingPathComponent("say?.mp3")
    let Path13 = Bundle.main.bundleURL.appendingPathComponent("non,non,non,say-^^.mp3")
    let Path14 = Bundle.main.bundleURL.appendingPathComponent("うるせいー.mp3")
    let Path15 = Bundle.main.bundleURL.appendingPathComponent("よっこらセィー.mp3")
